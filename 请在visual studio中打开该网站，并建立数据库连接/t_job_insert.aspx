<%@ Page Language="C#" AutoEventWireup="true" CodeFile="t_job_insert.aspx.cs" Inherits="t_job_insert" %>
...
<body class="g_body g_locale2052 ">
	...
	<form id="form1" runat="server">
         <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:middleschoolConnectionString %>" SelectCommand="SELECT * FROM [t_job]" DeleteCommand="DELETE FROM [t_job] WHERE [t_id] = @t_id" InsertCommand="INSERT INTO [t_job] ([t_id], [name], [date], [com]) VALUES (@t_id, @name, @date, @com)" UpdateCommand="UPDATE [t_job] SET [name] = @name, [date] = @date, [com] = @com WHERE [t_id] = @t_id">
             <DeleteParameters>
...
<div class="itemSep"></div><table title="" class="item itemCol9 itemIndex4  itemSelected itemSelectedIndex4" colid="9" id="nav9" onclick="window.open(&quot;/t_job_insert.aspx&quot;, &quot;_self&quot;)" _jump="window.open(&quot;/t_job_insert.aspx&quot;, &quot;_self&quot;)" cellpadding="0" cellspacing="0">
<tbody><tr>
<td class="itemLeft"></td>
...
<div class="titleText titleText326"><span>教师岗位证书</span></div>
</td>
<td class="titleRight titleRight326" valign="top">
    ...
    <br />
    岗位证书：<asp:TextBox ID="TextBox2" runat="server"></asp:TextBox>
    <br />
    颁发日期：<asp:TextBox ID="TextBox3" runat="server"></asp:TextBox>
    <br />
    颁发单位：<asp:TextBox ID="TextBox4" runat="server"></asp:TextBox>
    <br />
