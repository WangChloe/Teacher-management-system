...
<td class="titleRight titleRight326" valign="top">
    ...
    <br />
    性别:&nbsp; <asp:DropDownList ID="DropDownList1" runat="server" Height="33px" Width="51px">
        <asp:ListItem Value="男">男</asp:ListItem>
        <asp:ListItem Value="女">女</asp:ListItem>
    </asp:DropDownList>
    <br />
    身份证号：<asp:TextBox ID="TextBox3" runat="server"></asp:TextBox>
    <br />
    出生日期：<asp:TextBox ID="TextBox4" runat="server"></asp:TextBox>
    <br />
    籍贯：<asp:TextBox ID="TextBox5" runat="server"></asp:TextBox>
    <br />
    民族：<asp:TextBox ID="TextBox6" runat="server"></asp:TextBox>
    <br />
    宗教信仰：<asp:TextBox ID="TextBox7" runat="server"></asp:TextBox>
    <br />
    联系方式：<asp:TextBox ID="TextBox8" runat="server"></asp:TextBox>
    <br />
    邮箱：<asp:TextBox ID="TextBox9" runat="server"></asp:TextBox>
    <br />
    政治面貌：<asp:TextBox ID="TextBox10" runat="server"></asp:TextBox>
    <br />
    健康状况：<asp:TextBox ID="TextBox11" runat="server"></asp:TextBox>
    <br />
    家庭住址：<asp:TextBox ID="TextBox12" runat="server" Width="245px"></asp:TextBox>
    <br />
    户口所在地：<asp:TextBox ID="TextBox13" runat="server"></asp:TextBox>
    <br />
    婚姻状况：<asp:TextBox ID="TextBox14" runat="server"></asp:TextBox>
    <br />
    参加工作年月：<asp:TextBox ID="TextBox15" runat="server"></asp:TextBox>
    <br />
    来校年月：<asp:TextBox ID="TextBox16" runat="server"></asp:TextBox>
    <br />
    从教年月：<asp:TextBox ID="TextBox17" runat="server"></asp:TextBox>
    <br />
    办公室：<asp:TextBox ID="TextBox18" runat="server"></asp:TextBox>
    <br />
    工作状态：<asp:TextBox ID="TextBox19" runat="server"></asp:TextBox>
    <br />
    文化程度：<asp:TextBox ID="TextBox20" runat="server"></asp:TextBox>
    <br />
    编制类别：<asp:TextBox ID="TextBox21" runat="server"></asp:TextBox>
    <br />
    在职岗位：<asp:TextBox ID="TextBox22" runat="server"></asp:TextBox>
    <br />
    岗位等级：<asp:TextBox ID="TextBox23" runat="server"></asp:TextBox>
    <br />
    专业证书名称：<asp:TextBox ID="TextBox24" runat="server"></asp:TextBox>
    <br />
    <asp:Button ID="Button1" runat="server" Text="录入" OnClick="Button1_Click" />
&nbsp;&nbsp;&nbsp;
    <asp:Button ID="Button2" runat="server" Text="下一页" OnClick="Button2_Click" style="height: 21px" />
    <br />
