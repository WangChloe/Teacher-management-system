<%@ Page Language="C#" AutoEventWireup="true" CodeFile="job_select_normal.aspx.cs" Inherits="job_select_normal" %>
...
<body class="g_body g_locale2052 ">
	...
	<form id="form1" runat="server">
         <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:middleschoolConnectionString %>" SelectCommand="SELECT * FROM [t_job] WHERE ([t_id] = @t_id)">
             <SelectParameters>
...
<div class="itemSep"></div><table title="" class="item itemCol21 itemIndex31" colid="21" id="nav21" onclick="window.open(&quot;/bacg_select_normal.aspx&quot;, &quot;_self&quot;)" _jump="window.open(&quot;/bacg_select_normal.aspx&quot;, &quot;_self&quot;)" cellpadding="0" cellspacing="0">
<tbody><tr>
<td class="itemLeft"></td>
...
<div class="itemSep"></div><table title="" class="item itemCol9 itemIndex4  itemSelected itemSelectedIndex4" colid="9" id="nav9" onclick="window.open(&quot;/job_select_normal.aspx&quot;, &quot;_self&quot;)" _jump="window.open(&quot;/job_select_normal.aspx&quot;, &quot;_self&quot;)" cellpadding="0" cellspacing="0">
<tbody><tr>
<td class="itemLeft"></td>
