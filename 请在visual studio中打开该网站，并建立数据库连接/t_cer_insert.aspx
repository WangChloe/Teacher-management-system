<%@ Page Language="C#" AutoEventWireup="true" CodeFile="t_cer_insert.aspx.cs" Inherits="t_cer_insert" %>
...
<body class="g_body g_locale2052 ">
	...
	<form id="form1" runat="server">
         <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:middleschoolConnectionString %>" SelectCommand="SELECT * FROM [t_cer]" DeleteCommand="DELETE FROM [t_cer] WHERE [t_id] = @t_id" InsertCommand="INSERT INTO [t_cer] ([t_id], [x_name], [z_name], [m_name], [time], [date], [p_name], [num]) VALUES (@t_id, @x_name, @z_name, @m_name, @time, @date, @p_name, @num)" UpdateCommand="UPDATE [t_cer] SET [x_name] = @x_name, [z_name] = @z_name, [m_name] = @m_name, [time] = @time, [date] = @date, [p_name] = @p_name, [num] = @num WHERE [t_id] = @t_id">
             <DeleteParameters>
                 <asp:Parameter Name="t_id" Type="String" />
             </DeleteParameters>
             <InsertParameters>
                 <asp:ControlParameter ControlID="TextBox1" Name="t_id" PropertyName="Text" Type="String" />
                 <asp:ControlParameter ControlID="TextBox2" Name="x_name" PropertyName="Text" Type="String" />
                 <asp:ControlParameter ControlID="TextBox3" Name="z_name" PropertyName="Text" Type="String" />
                 <asp:ControlParameter ControlID="TextBox4" Name="m_name" PropertyName="Text" Type="String" />
                 <asp:ControlParameter ControlID="TextBox5" Name="time" PropertyName="Text" Type="DateTime" />
                 <asp:ControlParameter ControlID="TextBox6" Name="date" PropertyName="Text" Type="String" />
                 <asp:ControlParameter ControlID="TextBox7" Name="p_name" PropertyName="Text" Type="String" />
                 <asp:ControlParameter ControlID="TextBox8" Name="num" PropertyName="Text" Type="String" />
             </InsertParameters>
             <UpdateParameters>
...
<div class="itemSep"></div><table title="" class="item itemCol21 itemIndex31" colid="21" id="nav21" onclick="window.open(&quot;/t_bacg_insert.aspx&quot;, &quot;_self&quot;)" _jump="window.open(&quot;/t_bacg_insert.aspx&quot;, &quot;_self&quot;)" cellpadding="0" cellspacing="0">
<tbody><tr>
<td class="itemLeft"></td>
...
<div class="itemSep"></div><table title="" class="item itemCol103 itemIndex5  itemSelected itemSelectedIndex5" colid="103" id="nav103" onclick="window.open(&quot;/t_cer_insert.aspx&quot;, &quot;_self&quot;)" _jump="window.open(&quot;/t_cer_insert.aspx&quot;, &quot;_self&quot;)" cellpadding="0" cellspacing="0">
<tbody><tr>
<td class="itemLeft"></td>
...
<td class="titleRight titleRight326" valign="top">
    ...
    <br />
    系列名称：<asp:TextBox ID="TextBox2" runat="server"></asp:TextBox>
    <br />
    资格名称：<asp:TextBox ID="TextBox3" runat="server"></asp:TextBox>
    <br />
    专业名称：<asp:TextBox ID="TextBox4" runat="server"></asp:TextBox>
    <br />
    任职时间：<asp:TextBox ID="TextBox5" runat="server"></asp:TextBox>
    <br />
    任期：<asp:TextBox ID="TextBox6" runat="server"></asp:TextBox>
    <br />
    批准文号：<asp:TextBox ID="TextBox7" runat="server"></asp:TextBox>
    <br />
    证书编号：<asp:TextBox ID="TextBox8" runat="server"></asp:TextBox>
    <br />
